---
title: map
createTime: 2025/07/04 15:06:23
permalink: /golang/golang_study/map/
---


::: tip map是一种无序的基于key-value的数据结构，Go语言中的map是引用类型，必须初始化才能使用。
:::
...
语法为：`make(map([keyValue]valueType), [cap])`,
